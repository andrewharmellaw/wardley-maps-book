...
Given the above, the discussion on how the _“digital group will expand significantly over the next two years” _raises an eyebrow. I’d want to know more, are we talking about a hefty department or some cell based way of operating (e.g. two pizza). +
